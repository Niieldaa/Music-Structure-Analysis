...
# File paths
GT = r"C:\Users\nicol\Documents\GitHub\Music-Structure-Analysis\DO NOT TOUCH\GroundTruthData\GroundTruthRight\parsed_data_35.csv"
PRED = r"C:\Users\nicol\Documents\GitHub\Music-Structure-Analysis\DO NOT TOUCH\DataProcessing\OurOwnAnnotations\OurCSVData\Vigipirate_OurSegmenterChroma.csv"  # Replace with actual prediction file path
...
pd.DataFrame([{
    ...
    "Accuracy": accuracy,
    "F1 Score": f1_score
}]).to_csv("OurAnnotationsFMeasure/EmmanuelAnnotationsFMeasure/SingularFMeasure_Emmanuel_VigipirateChroma.csv", index=False)
